        ...
        <div class="page-title-box">
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">Harga Material</a></li>
                </ol>
            </div>
            <h4 class="page-title">Daftar Harga Material</h4>
        </div>
    </div>
</div>     
<!-- end page title --> 
...
<div class="row">
    <div class="col-10">
        <div class="card-box">
            <div class="row">
                <div class="col-4">
                    <a href="#" type="button" class="btn btn-info waves-effect waves-light"><span class="btn-label"><i class="mdi mdi-wall"></i></span>Tambah Material</a>
