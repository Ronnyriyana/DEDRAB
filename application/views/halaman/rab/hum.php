	...
	<div class="col-12">
		<div class="mt-4">
			...
			<ul class="nav nav-pills" id="myTabalt" role="tablist">
				<li class="nav-item">
					<a class="nav-link active" id="ded-tab1" data-toggle="tab" href="#ded"
						role="tab" aria-controls="rab" aria-expanded="true">DED</a>
				</li>
				<li class="nav-item">
			...
			<div class="tab-content text-muted" id="myTabaltContent">
				<div role="tabpanel" class="tab-pane fade in active show" id="ded"
				...
				<div class="tab-pane fade" id="dropdown1-alt" role="tabpanel"
					...
					<p>Etsy mixtape wayfarers, ethical wes anderson tofu before they sold out
						...
						banh mi whatever gluten-free, carles pitchfork fixie.</p>
				</div>
				<div class="tab-pane fade" id="dropdown2-alt" role="tabpanel"
					...
					<p>Trust fund seitan letterpress, keytar raw denim keffiyeh etsy art party
						...
						beer marfa ethical. Wolf salvia freegan sartorial keffiyeh.</p>
				</div>
			</div>
		</div>
	</div>
